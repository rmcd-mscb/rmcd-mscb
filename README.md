...
* [netcdf-viewer](https://github.com/rmcd-mscb/netcdf-viewer) A Visual Studio Code extension that lets you explore and inspect NetCDF files (.nc, .nc4, .cdf, .h5) directly within your editor.
* [weather-ensemble-agent](https://github.com/rmcd-mscb/weather-ensemble-agent)  I wanted to learn how to code up AI Agents.  This is An AI-powered weather forecast analysis tool that uses Claude (Anthropic) to analyze ensemble forecasts from multiple numerical weather prediction models. The agent autonomously fetches data, performs statistical analysis, and creates beautiful visualizations to help you understand forecast uncertainty.
